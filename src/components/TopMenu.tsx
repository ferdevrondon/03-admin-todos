                    ...
                    <div className="hidden md:block">
                        <div className="relative flex items-center text-gray-400 focus-within:text-cyan-400">
                            ...
                            <input
                                ...
                                className="w-full rounded-xl border border-gray-300 py-2.5 pr-4 pl-14 text-sm text-gray-600 outline-none transition focus:border-cyan-300"
                            />
                        </div>
                    </div>

                    {/* Mobile search */}
                    <button className="flex size-10 items-center justify-center rounded-xl border bg-gray-100 active:bg-gray-200 md:hidden">
                        <CiSearch />
                    </button>

                    <button className="flex size-10 items-center justify-center rounded-xl border bg-gray-100 active:bg-gray-200">
                        <CiChat1 size={25} />
                    </button>
